...
from attsystem.models import Courses, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    course=forms.ChoiceField(label="Batch",choices=course_list,widget=forms.Select(attrs={"class":"form-control"}))
